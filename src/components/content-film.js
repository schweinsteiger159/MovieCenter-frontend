              ...
              <div className="col-md-8 col-sm-12 col-xs-12">
                <div className="movie-single-ct main-content">
                  ...
                  <div className="movie-tabs">
                    <Tabs className="tabs">
                      <TabList className="tab-links tabs-mv tabs-series">
                        <Tab style={{ color: "#abb7c4", fontWeight: "bold", textTransform: "uppercase" }}>Tổng quan</Tab>
                        <Tab style={{ color: "#abb7c4", fontWeight: "bold", textTransform: "uppercase" }}>Trailer</Tab>
                      </TabList>
                     
                      <div className="tab-content">

                        <TabPanel id="overview" className="tab active">
                          <div className="row">
